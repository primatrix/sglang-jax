...
suites = {
    ...
    "unit-test-tpu-v6e-1": [
        ...
        TestFile("test/srt/test_deepseek_v4_mhc_head.py", 1, runner="pytest"),
    ...
    "unit-test-cpu": [
        ...
        TestFile("test/srt/test_deepseek_v4_csa_decode.py", 0.7, runner="pytest"),
        ...
        TestFile("test/srt/test_deepseek_v4_csa_attention.py", 0.4, runner="pytest"),
