"""Qwen2.5-VL vision encoder planning."""
...
class Qwen25VLVisionPlanBuilder(EncoderPlanBuilder):
    ...
    def __init__(self, model_config, input_buckets=None):
        ...
        if vision_cfg is None:
            raise ValueError(
                "Qwen2.5-VL vision planning requires model_config.hf_config.vision_config."
            )
