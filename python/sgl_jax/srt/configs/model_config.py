            ...
            if context_length > derived_context_len:
                if get_bool_env_var(
                    ...
                    logger.warning(
                        ...
                        f"This may lead to incorrect model outputs or errors."
                    )
                    self.context_len = context_length
                else:
                    raise ValueError(
                        f"User-specified context_length ({context_length}) is greater than the derived context_length ({derived_context_len}). "
                        f"This may lead to incorrect model outputs or errors. Note that the derived context_length may differ from max_position_embeddings in the model's config. "
