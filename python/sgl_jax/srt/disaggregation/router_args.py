...
class RouterArgs:
    ...
    prefill_urls: list[tuple[str, Optional[int]]] = dataclasses.field(
        default_factory=list
    )
    decode_urls: list[str] = dataclasses.field(default_factory=list)

    # Local deployment adapter: when the router talks to prefill through
    # localhost but decode must see the pod IP, inject this override.
    prefill_bootstrap_host: Optional[str] = None
