    ...
    for source in range(NDEV):
        for token in range(plan.tokens):
            ...
            for k_id in range(TOP_K):
                ...
                expected_scatter[owner, local_expert, scatter_slot] = value
                scatter_mask[owner, local_expert, scatter_slot] = True
                expected_gather[source, expert, occurrence] = value
                gather_mask[source, expert, occurrence] = True
    return (
