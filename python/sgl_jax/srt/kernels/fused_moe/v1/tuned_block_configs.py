...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, ...]]] = {
    ...
    # TPU v6e — MiMo-V2-Flash (hidden=4096, inter=2048, 256E, top_k=8, ep=16, FP8)
    # Tuned on v6e-16 (4x4, 4 hosts × 4 chips). See benchmark/moe/PROCESS_LOG.md.
    "TPU v6e": {
        ('bfloat16', 'float8_e4m3fn', 32, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 4096, 4096, 32, 32, 256, 512, 4096, 512),
        ('bfloat16', 'float8_e4m3fn', 64, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 4096, 4096, 32, 32, 256, 512, 4096, 512),
        ('bfloat16', 'float8_e4m3fn', 128, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 4096, 4096, 32, 16, 256, 512, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 256, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 4096, 4096, 32, 16, 256, 512, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 512, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 4096, 4096, 32, 16, 256, 512, 4096, 128),
        ('bfloat16', 'float8_e4m3fn', 1024, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 4096, 4096, 32, 16, 256, 512, 4096, 128),
        ('bfloat16', 'float8_e4m3fn', 2048, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 4096, 4096, 32, 16, 256, 512, 4096, 512),
        ('bfloat16', 'float8_e4m3fn', 4096, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 4096, 4096, 32, 16, 256, 512, 4096, 128),
        ('bfloat16', 'float8_e4m3fn', 8192, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 4096, 4096, 32, 16, 256, 512, 4096, 512),
    },
