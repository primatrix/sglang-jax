...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, int, int, int, int, int, int, int]]] = {
    ...
    "TPU v7": {
        ("bfloat16", 16, 256, 8, 8192, 2048, 8): (2, 2048, 2048, 2048, 2, 2048, 2048, 2048),
        ("bfloat16", 32, 256, 8, 8192, 2048, 8): (4, 2048, 2048, 2048, 4, 2048, 2048, 2048),
        ("bfloat16", 64, 256, 8, 8192, 2048, 8): (8, 2048, 2048, 2048, 8, 2048, 2048, 2048),
        ("bfloat16", 128, 256, 8, 8192, 2048, 8): (16, 2048, 2048, 2048, 16, 2048, 2048, 2048),
        ("bfloat16", 256, 256, 8, 8192, 2048, 8): (32, 2048, 2048, 2048, 32, 2048, 2048, 2048),
        ("bfloat16", 512, 256, 8, 8192, 2048, 8): (64, 1024, 4096, 4096, 64, 1024, 4096, 4096),
        ("bfloat16", 1024, 256, 8, 8192, 2048, 8): (128, 2048, 1024, 1024, 128, 2048, 1024, 1024),
        ("bfloat16", 2048, 256, 8, 8192, 2048, 8): (256, 1024, 2048, 2048, 256, 1024, 2048, 2048),
        ("bfloat16", 4096, 256, 8, 8192, 2048, 8): (512, 512, 1024, 1024, 512, 512, 1024, 1024),
