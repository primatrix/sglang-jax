...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, ...]]] = {
    ...
    "TPU v7": {
        ...
        # Ring-1T scaled: 64 experts, ep=8 (same per-device expert count as 256e/ep32)
        # Mapped by local_num_tokens (= num_tokens / ep_size):
        #   ep=8/64t(local=8) ← ep=32/256t(local=8), ep=8/128t(local=16) ← ep=32/512t(local=16), etc.
        ('bfloat16', 'bfloat16', 64, 64, 8, 8192, 2048, 8, False, False): (8, 2048, 2048, 2048, 8, 8, 2048, 2048, 2048, 2048),
        ('bfloat16', 'bfloat16', 128, 64, 8, 8192, 2048, 8, False, False): (16, 2048, 2048, 2048, 16, 16, 2048, 2048, 2048, 2048),
        ('bfloat16', 'bfloat16', 256, 64, 8, 8192, 2048, 8, False, False): (32, 512, 8192, 8192, 32, 32, 512, 8192, 8192, 512),
        ('bfloat16', 'bfloat16', 512, 64, 8, 8192, 2048, 8, False, False): (64, 1024, 2048, 2048, 64, 64, 1024, 2048, 2048, 1024),
        ('bfloat16', 'bfloat16', 1024, 64, 8, 8192, 2048, 8, False, False): (128, 1024, 1024, 1024, 128, 128, 1024, 1024, 1024, 1024),
