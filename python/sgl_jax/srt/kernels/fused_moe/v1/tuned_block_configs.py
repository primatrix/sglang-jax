...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, ...]]] = {
    ...
    "TPU v7": {
        ...
        ('bfloat16', 16, 256, 8, 8192, 2048, 8): (2, 2048, 2048, 2048, 2, 2048, 2048, 2048, 256),
        ('bfloat16', 32, 256, 8, 8192, 2048, 8): (4, 2048, 2048, 2048, 4, 2048, 2048, 2048, 128),
        ('bfloat16', 64, 256, 8, 8192, 2048, 8): (8, 2048, 2048, 2048, 8, 2048, 2048, 2048, 128),
        ('bfloat16', 128, 256, 8, 8192, 2048, 8): (16, 2048, 1024, 1024, 16, 2048, 1024, 1024, 256),
        ('bfloat16', 256, 256, 8, 8192, 2048, 8): (32, 2048, 1024, 1024, 32, 2048, 1024, 1024, 256),
        ('bfloat16', 512, 256, 8, 8192, 2048, 8): (64, 2048, 1024, 1024, 64, 2048, 1024, 1024, 256),
        ('bfloat16', 1024, 256, 8, 8192, 2048, 8): (128, 2048, 1024, 1024, 128, 2048, 1024, 1024, 256),
        ('bfloat16', 2048, 256, 8, 8192, 2048, 8): (128, 2048, 1024, 1024, 128, 2048, 1024, 1024, 256),
        ('bfloat16', 4096, 256, 8, 8192, 2048, 8): (256, 1024, 1024, 1024, 256, 1024, 1024, 1024, 256),
    },
...
DEFAULT_FUSED_MOE_BLOCK_CONFIG = FusedMoEBlockConfig(
    ...
    bd1c=1024,
    bd2c=1024,
    bse=128,  # 改为 256 以适配更大的 ep_size（例如 ep_size=8 时 local_se_inter=2048/8=256）
)
