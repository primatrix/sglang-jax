...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, int, int, int, int, int, int, int]]] = {
    ...
    "TPU v7": {
        # Decode shapes (small num_tokens) are particularly sensitive to VMEM headroom.
        ("bfloat16", 16, 256, 8, 8192, 2048, 8): (2, 1024, 2048, 2048, 2, 1024, 2048, 2048),
        ("bfloat16", 32, 256, 8, 8192, 2048, 8): (4, 1024, 2048, 2048, 4, 1024, 2048, 2048),
        ("bfloat16", 64, 256, 8, 8192, 2048, 8): (8, 1024, 2048, 2048, 8, 1024, 2048, 2048),
