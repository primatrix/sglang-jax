    ...
    *,
    ...
    b_se_w1_x2_vmem = (
        ...
        if w1_shared is None
            ...
            (2, t_packing, block_config.bd1 // t_packing, block_config.bf), w1_shared.dtype
        )
    )
    b_se_w2_x2_vmem = (
        None
        if w2_shared is None
            ...
            (2, t_packing, block_config.bf, block_config.bd2 // t_packing), w2_shared.dtype
        )
    )
    b_se_w3_x2_vmem = (
        None
        if w3_shared is None
            ...
            (2, t_packing, block_config.bd1 // t_packing, block_config.bf), w3_shared.dtype
        )
    )
    ...
    scratch_shapes = (
        ...
        shared_expert_acc,  # se_acc_vmem
        b_se_w1_x2_vmem,  # b_se_w1_x2_vmem
        b_se_w2_x2_vmem,  # b_se_w2_x2_vmem
        b_se_w3_x2_vmem,  # b_se_w3_x2_vmem
        b_se_w1_scale_x2_vmem,  # b_se_w1_scale_x2_vmem
        b_se_w2_scale_x2_vmem,  # b_se_w2_scale_x2
        b_se_w3_scale_x2_vmem,  # b_se_w3_scale_x2_vmem
        shared_expert_token,  # shared_expert_token
    )
        ...
        pl.pallas_call(
            ...
            grid_spec=pltpu.PrefetchScalarGridSpec(
                ...
                in_specs=[
                    ...
                    None if w3_shared is None else hbm_block_spec,
