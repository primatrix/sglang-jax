...
def _fused_ep_moe_kernel(
    ...
    *,
    ...
    num_experts_per_dp = num_experts // dp_size
    num_experts_per_tp = num_experts_per_dp // tp_size
    ...
    def get_mesh_device_id(ep_rank):
        dp_rank = ep_rank // num_experts_per_dp
        tp_rank = (ep_rank % num_experts_per_dp) // num_experts_per_tp
