    ...
    def forward_batch_generation(
        ...
        if new_logits_output is not None:
            ...
            if logits_output.next_token_top_logprobs_val is not None:
                logits_output.next_token_top_logprobs_val = logits_output.next_token_top_logprobs_val.astype(jnp.float32).tolist()
            ...
            if logits_output.next_token_token_ids_logprobs_val is not None:
                logits_output.next_token_token_ids_logprobs_val = logits_output.next_token_token_ids_logprobs_val.astype(jnp.float32).tolist()
            ...
            if logits_output.input_token_ids_logprobs_val is not None:
                logits_output.input_token_ids_logprobs_val = logits_output.input_token_ids_logprobs_val.astype(jnp.float32).tolist()
            ...
            if logits_output.input_top_logprobs_val is not None:
                logits_output.input_top_logprobs_val = logits_output.input_top_logprobs_val.astype(jnp.float32).tolist()
