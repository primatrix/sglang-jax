...
def _clear_multimodal_embedding_caches(
    ...
    for worker in workers:
        ...
        if id(runner) in seen:
            continue
        seen.add(id(runner))
        if runner.multimodal_embedding_cache is not None:
            runner.multimodal_embedding_cache.clear()
...
class Scheduler(
    ...
    def flush_cache(self) -> tuple[bool, str, int]:
        ...
        _clear_multimodal_embedding_caches(
