...
class EagleDraftInput:
    ...
    def tree_flatten(self):
        ...
        num_tokens_for_logprob_arr = _as_int32_array(
            self.num_tokens_for_logprob_per_batch
        )
...
class EagleVerifyInput:
    ...
    def verify(
        ...
        if not has_finished:
            ...
            accept_length_cpu_host = numpy.asarray(
                jax.device_get(accept_length), dtype=numpy.int32
            )
            draft_input = EagleDraftInput(
            ...
            if len(unfinished_accept_index) > 0:
                ...
                draft_input = EagleDraftInput(
                    ...
                    accept_length_cpu=jnp.asarray(
                        draft_input_accept_length_cpu, dtype=jnp.int32
                    ),
