...
class DeepseekV4TokenToKVPoolAllocator(BaseTokenToKVPoolAllocator):
    ...
    available for C2's wider request-slot/length/mapping transaction; this object
    ...
    def _release_pages(self, indices, dp_rank, swa_only):
        ...
        # handles: as in the existing allocator, C4 must clear the request owner.
        for page in pages:
    ...
    def restore_state(self, state):
        ...
        # Keep mapping references held by C2/C3 valid across a rollback.
