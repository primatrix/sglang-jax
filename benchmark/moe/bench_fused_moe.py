...
def _estimate_vmem_bytes(
    ...
    if use_shared_expert:
        ...
        # Shared output accumulation buffer: F32(2, bt, hidden_size).
        # This is always enabled in fused_ep_moe when shared_experts is provided.
    ...
    if verbose:
        ...
        if use_shared_expert:
            ...
            print(f"      b_se_acc_x2_vmem:       {_mb(se_acc)} MB  (2, {bt}, {hidden}) f32")
            if subc_quant_wsz is not None:
                bd1_per_pack = bd1 // t_packing
                bd2_per_pack = bd2 // t_packing
                print(
