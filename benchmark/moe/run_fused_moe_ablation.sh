...
COMMON_ARGS="--use-shared-expert --num-experts 256 --top-k 8 --hidden-size 8192 --intermediate-size 2048 --num-expert-group 8 --topk-group 4 --weight-dtype float8_e4m3fn --num-tokens ${NUM_TOKENS} --imbalance-mode sparse_hotspot --hotspot-ratio 1"
