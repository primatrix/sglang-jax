...
CASE_ENVS = {
    ...
    # S1 + S2 + routed expert compute, but no shared expert, gather, or output.
    # Used to split the visible main path into Stage3 and Stage5 increments.
    "routed_no_shared_no_gather_no_output": flags(
        FUSED_MOE_BENCHMARK_DISABLE_A2A_GATHER="True",
        FUSED_MOE_BENCHMARK_DISABLE_OUTPUT_ACCUMULATE="True",
        FUSED_MOE_BENCHMARK_DISABLE_SHARED_EXPERT="True",
    ),
    # Isolated shared expert path. This is not directly additive with full because
    # shared expert work overlaps routed expert work, but it is useful as an
    # "actual cost" cross-check for Stage5.
    "stage5_shared_only": flags(
        FUSED_MOE_BENCHMARK_DISABLE_A2A_SCATTER="True",
        FUSED_MOE_BENCHMARK_DISABLE_A2A_GATHER="True",
        FUSED_MOE_BENCHMARK_DISABLE_DYNAMIC_FFN1="True",
        FUSED_MOE_BENCHMARK_DISABLE_DYNAMIC_FFN2="True",
