...
RESULT_ROOT=/tmp/dspark_stage2_sts_v2
...
print(open("/tmp/dspark_stage2_sts_v2/sts_table.json", encoding="utf-8").read())
print("STS_TABLE_END")
PY
...
echo "DSPARK_STS_V2_READY=$RESULT_ROOT"
