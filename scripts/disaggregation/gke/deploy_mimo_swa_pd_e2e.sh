...
ROUTER_PD_PREFILL_MAX_INFLIGHT_REQUESTS="${ROUTER_PD_PREFILL_MAX_INFLIGHT_REQUESTS:-0}"
...
render() {
  sed \
    ...
    -e "s|<ROUTER_PD_PREFILL_MAX_INFLIGHT_REQUESTS>|$(escape_sed "$ROUTER_PD_PREFILL_MAX_INFLIGHT_REQUESTS")|g" \
