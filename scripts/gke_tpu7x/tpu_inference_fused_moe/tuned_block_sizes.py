...
TUNED_BLOCK_SIZES = {
    ...
    # Tuned on TPU v7x-8 via tune_tpu_inference_moe.py
    (8192, 2048, 64, 8, 2, 2, 64, 8): (8, 2048, 2048, 2048, 8, 2048, 2048, 2048),
    (8192, 2048, 64, 8, 2, 2, 128, 8): (16, 2048, 512, 4096, 2, 2048, 512, 4096),
    (8192, 2048, 64, 8, 2, 2, 256, 8): (32, 2048, 512, 2048, 32, 2048, 256, 256),
    (8192, 2048, 64, 8, 2, 2, 512, 8): (64, 1024, 512, 1024, 64, 1024, 512, 1024),
    (8192, 2048, 64, 8, 2, 2, 1024, 8): (64, 1024, 512, 1024, 64, 1024, 512, 1024),
}
