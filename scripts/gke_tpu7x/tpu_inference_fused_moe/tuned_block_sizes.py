...
TUNED_BLOCK_SIZES = {
    ...
    # Ring-1T scaled: 64 experts, ep=8, hidden=8192, intermediate=2048 (bf16)
    # Tuned on TPU v7x-8 via tune_tpu_inference_moe.py (comprehensive search, 40 configs/token)
    (8192, 2048, 64, 8, 2, 2, 64, 8): (8, 2048, 2048, 2048, 4, 2048, 2048, 2048),  # 1.437 ms
    (8192, 2048, 64, 8, 2, 2, 128, 8): (4, 2048, 2048, 2048, 4, 2048, 2048, 2048),  # 1.427 ms
    (8192, 2048, 64, 8, 2, 2, 256, 8): (32, 2048, 512, 2048, 32, 2048, 512, 2048),  # 1.944 ms
    (8192, 2048, 64, 8, 2, 2, 512, 8): (64, 1024, 512, 1024, 64, 1024, 512, 1024),  # 2.431 ms
    (8192, 2048, 64, 8, 2, 2, 1024, 8): (64, 1024, 512, 1024, 64, 1024, 512, 1024),  # 4.306 ms
}
